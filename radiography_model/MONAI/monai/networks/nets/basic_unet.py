...
__all__ = ["BasicUNet", "BasicUnet", "Basicunet" , "BasicUNet_Aux" ,"BasicUNet_Shallow_Aux"]
...
class BasicUNet_Shallow_Aux(nn.Module):
    def __init__(
        self,
        dimensions: int = 3,
        in_channels: int = 1,
        ...
        fea = ensure_tuple_rep(features, 6)
        print(f"BasicUNet_Shallow_Aux features: {fea}.")
...
BasicUnet_shallow_aux = Basicunet_shallow_aux = BasicUNet_Shallow_Aux
